...
export interface WelcomeAdminEmailData {
  adminName: string;
  schoolName: string;
  subdomain: string;
  email: string;
...
export const WelcomeAdminEmailTemplate = ({
  adminName,
  schoolName,
  email,
  password,
  loginUrl
}: WelcomeAdminEmailData): string => {
  return `<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>🎉 Welcome to Lectify MultiSchool - ${schoolName} Setup Complete!</title>
    <!--[if mso]>
    <noscript>
        <xml>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <p style="margin: 0 0 32px 0; color: #475569; font-size: 18px; line-height: 1.7; font-weight: 400;" class="welcome-text">
                                            Congratulations! Your <strong style="color: #6366f1; font-weight: 700;">${schoolName}</strong> dashboard has been successfully set up and is ready to use. You now have access to all the powerful features of the Lectify MultiSchool platform.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%); border-radius: 16px; padding: 32px; border: 2px solid #e2e8f0;" class="credentials-table">
                                <tr>
                                    <td>
                                        ...
                                        <p style="margin: 20px 0 0 0; color: #ef4444; font-size: 14px; text-align: center; font-weight: 500;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="padding-left: 16px; vertical-align: top;" class="feature-content">
                                                                ...
                                                                <p style="margin: 0; color: #64748b; font-size: 15px; line-height: 1.5;" class="feature-description">
                                                                    Add and manage students, teachers, and staff with comprehensive role-based access control
                                                                </p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                        <tr>
                                                            ...
                                                            <td style="padding-left: 16px; vertical-align: top;" class="feature-content">
                                                                ...
                                                                <p style="margin: 0; color: #64748b; font-size: 15px; line-height: 1.5;" class="feature-description">
                                                                    Create courses, manage timetables, and organize academic schedules seamlessly
                                                                </p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                            ...
                                            <tr>
                                                <td style="padding-bottom: 20px;">
                                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                        <tr>
                                                            <td width="48" style="vertical-align: top; padding-top: 2px;">
                                                                <div style="width: 32px; height: 32px; background: linear-gradient(135deg, #f59e0b, #d97706); border-radius: 50%; margin: 0 auto; display: table-cell; vertical-align: middle; text-align: center; box-shadow: 0 4px 8px rgba(245, 158, 11, 0.3);" class="feature-icon">
                                                                    <span style="color: #ffffff; font-size: 16px; font-weight: 700; display: inline-block; vertical-align: middle;">📊</span>
                                                                </div>
                                                            </td>
                                                            <td style="padding-left: 16px; vertical-align: top;" class="feature-content">
                                                                ...
                                                                <p style="margin: 0; color: #64748b; font-size: 15px; line-height: 1.5;" class="feature-description">
                                                                    Track attendance, generate detailed reports, and gain insights into school performance
                                                                </p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                            ...
                                            <tr>
                                                <td>
                                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                        <tr>
                                                            <td width="48" style="vertical-align: top; padding-top: 2px;">
                                                                <div style="width: 32px; height: 32px; background: linear-gradient(135deg, #8b5cf6, #7c3aed); border-radius: 50%; margin: 0 auto; display: table-cell; vertical-align: middle; text-align: center; box-shadow: 0 4px 8px rgba(139, 92, 246, 0.3);" class="feature-icon">
                                                                    <span style="color: #ffffff; font-size: 16px; font-weight: 700; display: inline-block; vertical-align: middle;">💬</span>
                                                                </div>
                                                            </td>
                                                            <td style="padding-left: 16px; vertical-align: top;" class="feature-content">
                                                                ...
                                                                <p style="margin: 0; color: #64748b; font-size: 15px; line-height: 1.5;" class="feature-description">
                                                                    Connect with parents, students, and staff through integrated messaging and notifications
                                                                </p>
                                                            </td>
                                                        </tr>
                                                    </table>
...
export const getWelcomeEmailSubject = (schoolName: string): string => {
  return `🎉 Welcome to Lectify MultiSchool - ${schoolName} Setup Complete!`;
};
